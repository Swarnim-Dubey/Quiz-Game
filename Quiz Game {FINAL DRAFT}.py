...
'Double dip', 'Flip the question']
	...
	print("Press 1 for 50:50, 2 for double dip\
	or 3 for flip the question\t")
...
'''def audience(ran, opts):
	...
	s =([opt1[ran], opt2[ran], opt3[ran], opt4[ran]],
				['1', '2', '3', '4'])
	...
	if give_answer == 9:
		...
		if condition <= 4:
			...
			if give_ans == 0:
				...
				print("Correct, You have won Points. =", end="")
				correct += 1
				total_amt = amount(correct)
		...
		if give_answer == 0:
			...
			print("Correct answer.., You have won Points.=", end="")
			correct += 1
			total_amt = amount(correct)
...
print("Your winning points are. ", total_amt)
